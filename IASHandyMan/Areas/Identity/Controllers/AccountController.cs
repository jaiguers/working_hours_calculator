...
using IASHandyMan.EmailCommunication;
using IASHandyMan.EmailCommunication.Interface;
using IASHandyMan.Areas.Identity.Models;
using IASHandyMan.Areas.Identity.Models.ViewModels;
...
namespace IASHandyMan.Areas.Identity.Controllers
{
    [Area("Identity")]
